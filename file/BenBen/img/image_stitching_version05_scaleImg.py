...
# -*- coding: utf-8 -*-
"""
Created on Wed May 20 14:44:30 2020

@author: shuaiwang

scale image,find the H by small images, then use original image for stitching
"""
...
def scaleImages(images, fixmax):
    ...
    for img in images:
        ...
        print('Resized Dimensions : '+str(img.shape)+'=>'+str(resized.shape))
...
#     if i == 0:
#         simg = scaleTwoImages(images[i+1],images[i], fixmax)
#         H = findhomograpyh(simg[0],simg[1])
...
#         continue
#     if i+1 <= mid:
#         simg = scaleTwoImages(images[i+1],result, fixmax)
#         H = findhomograpyh(simg[0],simg[1])
...
#         simg = scaleTwoImages(images[k], images[k+1], fixmax)
#         H = findhomograpyh(simg[0],simg[1])
...
#         continue
#     if i+1 > mid+1 and i < num-2:
#         simg = scaleTwoImages(images[k], result2, fixmax)
#         H = findhomograpyh(simg[0],simg[1])
...
#         continue
#     if i == num-2:
#         simg = scaleTwoImages(result, result2, fixmax)
#         H = findhomograpyh(simg[0],simg[1])
